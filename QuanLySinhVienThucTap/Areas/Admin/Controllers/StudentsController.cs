                ...
                if ((file != null) && (file.ContentLength > 0) && !string.IsNullOrEmpty(file.FileName))
                {
                    ...
                    using (var package = new ExcelPackage(file.InputStream))
                    {
                        ...
                        for (int rowIterator = 2; rowIterator <= noOfRow; rowIterator++)
                        {
                            ...
                            student.StudentCode = workSheet.Cells[rowIterator, 2].Value.ToString();
                            student.LastName = workSheet.Cells[rowIterator, 3].Value.ToString();
                            student.FirstName = workSheet.Cells[rowIterator, 4].Value.ToString();
                            student.Gender = workSheet.Cells[rowIterator, 5].Value.ToString();
                            string dateString = workSheet.Cells[rowIterator, 6].Value.ToString();
                            ...
                            student.Email = workSheet.Cells[rowIterator, 7].Value.ToString();
                            student.PhoneNumber = workSheet.Cells[rowIterator, 8].Value.ToString();
                            student.Classroom = workSheet.Cells[rowIterator, 9].Value.ToString();
                            student.GPAScore = Convert.ToDecimal(workSheet.Cells[rowIterator, 10].Value);
                            student.LetterScore = workSheet.Cells[rowIterator, 11].Value.ToString();
                            student.Address = workSheet.Cells[rowIterator, 12].Value.ToString();
                            string statusString = workSheet.Cells[rowIterator, 13].Value.ToString();
                            bool isCheck;
                    ...
                    {
                        bool studentExists = db.Students.Any(s => s.StudentCode == item.StudentCode);
                        if (studentExists)
                        {
                            continue;
                        }
